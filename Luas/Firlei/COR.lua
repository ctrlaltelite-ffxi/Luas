...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {
        ...
        back={ name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Mag. Evasion+15',}},
    ...
    sets.precast.RA = {
        ammo=gear.RAbullet,
        head="Chass. Tricorne +1", --10/0
        body="Oshosi Vest", --14/0 								--NEED!!!!
        hands="Carmine Fin. Ga. +1", --8/11
        legs="Adhemar Kecks +1", --9/10 -- 			NEED!!!
        feet="Meg. Jam. +1", --10/0
		neck="Comm. Charm +1", --3
    ...
    sets.precast.RA.Flurry2 = set_combine(sets.precast.RA.Flurry1, {
        ...
        waist="Yemaya Belt", --3/0 -- 															TAKE OUT OF STORAGE
        }) --30/65
    ...
    sets.precast.WS = {
        ...
        back={ name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','AGI+10','Weapon skill damage +10%',}}, -- NEED!!!!
        waist="Fotia Belt",
        }
    ...
    sets.precast.WS['Last Stand'].Acc = set_combine(sets.precast.WS['Last Stand'], {
        ...
        ear1="Beyla Earring", -- NEED!!!!
        ear2="Telos Earring",
        ring2="Cacoethic Ring +1", -- NEED!!!!
        waist="K. Kachina Belt +1",
        })

    sets.precast.WS['Wildfire'] = {
        ammo=gear.MAbullet,
        head="Nyame helm", --{ name="Herculean Helm", augments={'"Mag.Atk.Bns."+30','"Rapid Shot"+1','"Store TP"+2','Mag. Acc.+16 "Mag.Atk.Bns."+16',}}, -- Need MAGICK ATK Helm
        body="Lanun Frac +3",
        ...
        back={ name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','AGI+10','Weapon skill damage +10%',}}, -- NEED WSD CAPE
        }
    ...
    sets.precast.WS['Evisceration'] = {
        ...
        body="Adhemar Jacket +1",--"Abnoba Kaftan",
        hands="Mummu Wrists +2",
        legs="Samnuha Tights",--"Zoar Subligar +1",
        feet="Mummu Gamash. +2",
        neck="Fotia Gorget",
        ear1="Mache Earring +1",
        ear2="Odr Earring",
        ring1="Ramuh Ring", -- NEED!!!!
        ring2="Mummu Ring",
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {
        head="Herculean Helm", -- SHOULD BE WSD and STR
        hands="Meg. Gloves +1",
        legs="Meg. Chausses +2",
        neck="Comm. Charm +1",
        ring1="Shukuyu Ring",
        ring2="Epaminondas's Ring",
        back={ name="Camulus's Mantle", augments={'STR+20','Accuracy+19 Attack+19','Weapon skill damage +10%',}}, -- NEED!!!!!
        waist="Sailfi Belt +1",
        })
    ...
    sets.midcast.CorsairShot['Light Shot'] = {
        ...
        head="Laksa. Tricorne +1",
        body="Meg. Cuirie +2",
        hands="Ikenga's Gloves", -- "Laksa. Gants +3",
        legs="Ikenga's Trousers", -- "Malignance Tights",
        feet="Ikenga's Clogs", -- "Laksa. Boots +3",
        neck="Comm. Charm +1",
    ...
    sets.midcast.RA = {
        ammo=gear.RAbullet,
        head="Malignance Chapeau", --"Ikenga's Hat",
        body="Malignance Tabard",  --"Ikenga's Vest",
        hands="Meg. Gloves +1", --"Ikenga's Gloves",
        legs="Meg. Chausses +2", --"Ikenga's Trousers", - +2 AMBU LEGS
        feet="Malignance Boots", -- "Ikenga's Clogs",
        neck="Iskur Gorget",
        ear1="Dedition Earring",
        ear2="Telos Earring",
        ring1="Dingir Ring",
    ...
    sets.idle.DT = set_combine(sets.idle, {
        ...
        ring1="Chirich Ring +1",
        ring2="Chirich Ring +1",
        back={ name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Damage taken -5%',}}, --6/6
        })
    ...
    sets.engaged = {
		...
		feet={ name="Herculean Boots", augments={'"Triple Atk."+4','AGI+4','Accuracy+13','Attack+15',}}, -- NEED SOME HERC TRIPLE ATK AUGMENTS
    ...
    sets.engaged.DW = {
        ...
        ring1="Petrov Ring",
        ring2="Epona's Ring",
        back={ name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Damage taken -5%',}}, --10
        waist="Reiki Yotai", --7
      } -- 48%
    ...
    sets.DeathPenalty_M = {main="Rostam", sub="Tauret", ranged="Molybdosis"}
    sets.DeathPenalty_R = {main="Lanun Knife", sub="Tauret", ranged="Molybdosis"}
    sets.Armageddon_M = {Main="Rostam", sub="Tauret", ranged="Armageddon"}
    ...
    sets.Anarchy = {main="Naegling", sub="Gleti's Knife", ranged="Anarchy +2"} --"Blurred Knife +1"
...
function do_bullet_checks(spell, spellMap, eventArgs)
    ...
    elseif spell.type == 'CorsairShot' then
        bullet_name = "Animikii Bullet"
    elseif spell.action_type == 'Ranged Attack' then
        bullet_name = "Chrono Bullet"
        if buffactive['Triple Shot'] then
            bullet_min_count = 3
        end
    end
    ...
    if not available_bullets then
        if spell.type == 'CorsairShot' and player.equipment.ammo ~= 'empty' then
            ...
            return
        elseif spell.type == 'WeaponSkill' and player.equipment.ammo == "Chrono Bullet" then
...
function set_lockstyle()
	...
	add_to_chat (55, 'Slip: 18, 21, 23, 26, 27')
end