...
function init_gear_sets()
    ...
    sets.precast.RA = {
        ...
        feet="Meg. Jam. +2", --10/0
		neck="Comm. Charm +1", --3
        back={ name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','"Store TP"+10',}}, --10/0
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {
        head={ name="Herculean Helm", augments={'Pet: "Regen"+2','Pet: Accuracy+29 Pet: Rng. Acc.+29','Weapon skill damage +9%','Accuracy+16 Attack+16',}},
        hands="Meg. Gloves +2",
        legs="Meg. Chausses +2",
        neck="Comm. Charm +1",
        ring1="Regal Ring",
    ...
    sets.idle.DT = set_combine(sets.idle, {
        ...
        ring1="Chirich Ring +1",
        ring2="Chirich Ring +1",
        back={ name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Mag. Evasion+15',}}, --6/6
        })
    ...
    sets.engaged.DW = {
        ...
        ring1="Petrov Ring",
        ring2="Epona's Ring",
        back={ name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','"Store TP"+10',}}, --10
        waist="Reiki Yotai", --7
      } -- 48%
    ...
    sets.DeathPenalty_M = {main={name="Rostam", bag="wardrobe3"}, sub="Tauret", ranged="Molybdosis"}
    ...
    sets.Anarchy = {sub="Gleti's Knife", ranged="Anarchy +2"} --"Blurred Knife +1"
