...
function init_gear_sets()
    ...
    sets.precast.JA['Nether Void']  = {legs="Bale Flanchard +1"}
    ...
    sets.midcast['Drain'] = {
		...
		back={ name="Niht Mantle", augments={'Attack+5','Dark magic skill +2','"Drain" and "Aspir" potency +23',}}
		}

    -- Absorbs
    sets.midcast.Absorb = set_combine(sets.midcast['Dark Magic'], {
        head="Ignominy Burgonet", -- 17
    ...
    sets.precast.WS ['Torcleaver'] = {
        ammo="Knobkierrie",
		head={ name="Odyssean Helm", augments={'Accuracy+15','Weapon skill damage +4%','DEX+9','Attack+4',}},
		...
		back={ name="Ankou's Mantle", augments={'VIT+20','Accuracy+20 Attack+20','VIT+7','Weapon skill damage +10%',}},
		}
    ...
    sets.defense.PDT = {
        ...
        -- legs="Ignominy Flanchard +1", -- 5% haste
