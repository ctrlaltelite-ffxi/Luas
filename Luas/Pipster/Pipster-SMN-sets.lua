...
bpmagicaccstaff = { name="Keraunos", augments={'Pet: "Regen"+1',}}
smnskillstaff = { name="Espiritus", augments={'Enmity-6','Pet: "Mag.Atk.Bns."+30','Pet: Damage taken -4%',}}
avatarattackstaff = { name="Gridarvor", augments={'Pet: Accuracy+70','Pet: Attack+70','Pet: "Dbl. Atk."+15',}}
refreshstaff ={ name="Gridarvor", augments={'Pet: Accuracy+70','Pet: Attack+70','Pet: "Dbl. Atk."+15',}}
gada = { name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+4',}}

--[#2 Augmented Items & JSE Cape ]--
conveyance = "Conveyance Cape"
conveyanceskill="Conveyance Cape"
campestres_magic="Campestres's Cape"
campestres_att="Campestres's Cape"
campestres_idle="Campestres's Cape"
campestres_fc="Campestres's Cape"
...
sets.apogeephy_path = {
    --feet={ name="Apogee Pumps", augments={'MP+80','Pet: Attack+35','Blood Pact Dmg.+8',}},
}
apogee_crown_phy="Apogee Crown"
apogee_crown_mag="Apogee Crown"

apogee_slacks_phy="Apogee Slacks"
--apogee_slacks_mag={ name="Apogee Slacks", augments={'MP+60','Pet: "Mag.Atk.Bns."+30','Blood Pact Dmg.+7',}}
apogee_slacks_phy="Apogee Slacks"
apogee_slacks_mag="Apogee Slacks"


moonshade="Moonshade Earring"

sets.enticers = {
	--legs={ name="Enticer's Pants", augments={'MP+20','Pet: Mag. Acc.+4',}}
    legs="Enticer's Pants",
}
enticers ="Enticer's Pants"
...
glyphichorn="Glyphic Horn"
glypchicbracers="Glyphic Bracers +1"
glyphicspats="Glyphic Spats +1"
selenian="Selenian Cap"

telch_head="Telchine Cap"
telch_body="Telchine Chas."
telch_hands="Telchine Gloves"
telch_legs="Telchine Braconi"
telch_feet="Telchine Pigaches"

merlinic_head_fc="Merlinic Hood" --14
merlinic_head_mab="Merlinic Hood"

merlinic_body_mab="Merlinic Jubbah"

merlinic_hands="Merlinic Dastanas"
merlinic_hands_fc = "Merlinic Dastanas" --6
merlinic_hands_mab="Merlinic Dastanas"
merlinic_hands_refresh="Merlinic Dastanas"


merlinic_legs_mburst="Merlinic Shalwar"--15

merlinic_feet_fc="Merlinic Crackows"--11
merlinic_feet_refresh="Merlinic Crackows"


amal_head="Amalric Coif"
amal_hands="Amalric Gages"
...
sets.smnskill = {
	...
	back={ name="Conveyance Cape", augments={'Summoning magic skill +4','Pet: Enmity+14','Blood Pact Dmg.+4','Blood Pact ab. del. II -3',}} 
}
...
sets.perp['Cait Sith'] = set_combine(sets.perp, {hands="Lamassu Mitts"})
