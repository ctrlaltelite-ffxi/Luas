...
function init_gear_sets()
    ...
    sets.midcast.EnhancingDuration = {
        ...
        feet={ name="Telchine Pigaches", augments={'Enh. Mag. eff. dur. +9',}},--"Theo. Duckbills +2",
        waist="Embla Sash",
        }
    ...
    sets.midcast.Regen = set_combine(sets.midcast.EnhancingDuration, {
        ...
        body="Piety Bliaut +3",
        hands={ name="Telchine Gloves", augments={'Enh. Mag. eff. dur. +9',}}, --gear.Telchine_ENH_hands,
        legs={ name="Telchine Braconi", augments={'Enh. Mag. eff. dur. +10',}}, --gear.Telchine_ENH_legs,
        feet={ name="Telchine Pigaches", augments={'Enh. Mag. eff. dur. +9',}}, --gear.Telchine_ENH_feet,
        })
