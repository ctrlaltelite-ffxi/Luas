...
function get_sets()
  ...
  sets.midcast["Astral Flow"] = { head="Glyphic Horn +3" }
	...
	sets.pet_midcast.Physical_BP = {
		...
		sub="Elan Strap +1",
		ammo="Sancus Sachet +1",
		head={ name="Helios Band", augments={'Pet: Attack+26 Pet: Rng.Atk.+26','Pet: "Dbl. Atk."+8','Blood Pact Dmg.+7',}},
    ...
    left_ring="Varar Ring +1",
    right_ring="Varar Ring +1",
		back={ name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Eva.+20 /Mag. Eva.+20','Pet: Mag. Acc.+10','Pet: Haste+10','Pet: Damage taken -5%',}},
	...
	send_command('input /macro book 13;wait .1;input /macro set 1;wait 3;input /lockstyleset '..StartLockStyle)
