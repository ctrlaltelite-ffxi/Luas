    ...
    sets.precast.Waltz = 
{
	...
	sets.precast.FC = {
        ...
        back={ name="Mecisto. Mantle", augments={'Cap. Point+43%','HP+23','DEF+3',}},
    }     
	sets.precast.FC.DT = 
{ 
    ammo="Impatiens",
    ...
    sets.midcast.Divine = 
{
    ...
    head={ name="Jumalik Helm", augments={'MND+10','"Mag.Atk.Bns."+15','Magic burst dmg.+10%','"Refresh"+1',}},
    body="Rev. Surcoat +3",
    hands={ name="E//schite Gauntlets", augments={'Mag. Evasion+15','Spell interruption rate down +15%','Enmity+7',}},
	...
	sets.midcast['Jettatura'] = 
{
    ...
    sets.Doom = {neck="Nicander's Necklace", legs="Shabti Cuisses",left_ring="Saida Ring",right_ring="Purity Ring", waist="Gishdubar Sash"} -- +85%
  ...
  --3367 HP   
	...
	sets.defense.BDT = set_combine(sets.idle,{})
	sets.defense.ResistCharm = set_combine(sets.idle,{})
    sets.defense.Ochain = set_combine(sets.idle,{})
    sets.defense.Aegis = set_combine(sets.idle,{})
    sets.defense.Srivatsa = set_combine(sets.idle,{})
