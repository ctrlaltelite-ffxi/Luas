...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'Annihilator', 'Fomalhaut', 'Armageddon', 'Accipiter', 'Teller', 'Doomsday'}
...
function init_gear_sets()
    ...
    sets.precast.RA = {
        ...
        body="Arcadian Jerkin +1", --14/0
        hands="Carmine Fin. Ga. +1", --8/11
        legs="Adhemar Kecks", --10/13
        feet="Meg. Jam. +1", --10/0
        back="Belenus's Cape", --10/0
