...
function get_sets()
    ...
    sets.TP.Liberator.HighACC.AM3 =
        set_combine(sets.TP.Liberator.MidACC.AM3, {})
    ...
    sets.TP.Liberator.MidACC.AM3_HighHaste =
        set_combine(sets.TP.Liberator.AM3_HighHaste, {})
    sets.TP.Liberator.HighACC.AM3_HighHaste =
        set_combine(sets.TP.Liberator.MidACC.AM3_HighHaste, {})
    ...
    sets.TP.Liberator.HighHaste.STP = set_combine(sets.TP.Liberator.HighHaste,
                                                  {})
    sets.TP.Liberator.MidACC.HighHaste.STP =
        set_combine(sets.TP.Liberator.MidACC.HighHaste, {})
    sets.TP.Liberator.HighACC.HighHaste.STP =
        set_combine(sets.TP.Liberator.HighACC.HighHaste, {})

    -- Liberator(AM3 Up: High Haste + SAM Roll) TP Sets --
    sets.TP.Liberator.AM3_HighHaste.STP =
        set_combine(sets.TP.Liberator.HighHaste, {})
    sets.TP.Liberator.MidACC.AM3_HighHaste.STP =
        set_combine(sets.TP.Liberator.MidACC.HighHaste, {})
    sets.TP.Liberator.HighACC.AM3_HighHaste.STP =
        set_combine(sets.TP.Liberator.HighACC.HighHaste, {})
    ...
    sets.TP.Liberator.SAM.AM3_HighHaste =
        set_combine(sets.TP.Liberator.SAM.AM3, {waist = "Sailfi belt +1"})
    sets.TP.Liberator.SAM.MidACC.AM3_HighHaste =
        set_combine(sets.TP.Liberator.SAM.AM3_HighHaste, {})
    sets.TP.Liberator.SAM.HighACC.AM3_HighHaste =
        set_combine(sets.TP.Liberator.SAM.MidACC.AM3_HighHaste, {})
    ...
    sets.TP.Liberator.SAM.HighHaste.STP = set_combine(
                                              sets.TP.Liberator.SAM.HighHaste,
                                              {})
    sets.TP.Liberator.SAM.MidACC.HighHaste.STP =
        set_combine(sets.TP.Liberator.SAM.MidACC.HighHaste, {})
    sets.TP.Liberator.SAM.HighACC.HighHaste.STP =
        set_combine(sets.TP.Liberator.SAM.HighACC.HighHaste, {})

    -- Liberator(AM3 Up: High Haste + SAM Roll) /SAM TP Sets --
    sets.TP.Liberator.SAM.AM3_HighHaste.STP = set_combine(
                                                  sets.TP.Liberator.SAM
                                                      .HighHaste, {})
    sets.TP.Liberator.SAM.MidACC.AM3_HighHaste.STP = set_combine(sets.TP
                                                                     .Liberator
                                                                     .SAM.MidACC
                                                                     .HighHaste,
                                                                 {})
    sets.TP.Liberator.SAM.HighACC.AM3_HighHaste.STP = set_combine(sets.TP
                                                                      .Liberator
                                                                      .SAM
                                                                      .HighACC
                                                                      .HighHaste,
    ...
    sets.TP.Ragnarok.HighHaste.STP = set_combine(sets.TP.Ragnarok.STP,
                                                 {waist = "Sailfi belt +1"})
    sets.TP.Ragnarok.MidACC.HighHaste.STP = set_combine(
                                                sets.TP.Ragnarok.MidACC.STP,
                                                {waist = "Sailfi belt +1"})
    sets.TP.Ragnarok.HighACC.HighHaste.STP =
        set_combine(sets.TP.Ragnarok.HighACC.STP, {waist = "Sailfi belt +1"})
    ...
    sets.TP.Ragnarok.SAM.HighHaste.STP =
        set_combine(sets.TP.Ragnarok.SAM.STP, {waist = "Sailfi belt +1"})
    sets.TP.Ragnarok.SAM.MidACC.HighHaste.STP = set_combine(
                                                    sets.TP.Ragnarok.SAM.MidACC
                                                        .STP,
                                                    {waist = "Sailfi belt +1"})
    sets.TP.Ragnarok.SAM.HighACC.HighHaste.STP =
        set_combine(sets.TP.Ragnarok.SAM.HighACC.STP, {waist = "Sailfi belt +1"})
    ...
    sets.TP.Apocalypse.HighHaste = set_combine(sets.TP.Apocalypse,
                                               {waist = "Sailfi belt +1"})
    sets.TP.Apocalypse.MidACC.HighHaste =
        set_combine(sets.TP.Apocalypse.MidACC, {waist = "Sailfi belt +1"})
    sets.TP.Apocalypse.HighACC.HighHaste =
        set_combine(sets.TP.Apocalypse.HighACC, {waist = "Sailfi belt +1"})
    ...
    sets.TP.Apocalypse.HighHaste.STP = set_combine(sets.TP.Apocalypse.STP,
                                                   {waist = "Sailfi belt +1"})
    sets.TP.Apocalypse.MidACC.HighHaste.STP =
        set_combine(sets.TP.Apocalypse.MidACC.STP, {waist = "Sailfi belt +1"})
    sets.TP.Apocalypse.HighACC.HighHaste.STP =
        set_combine(sets.TP.Apocalypse.HighACC.STP, {waist = "Sailfi belt +1"})
    ...
    sets.TP.Apocalypse.AM.HighHaste = set_combine(sets.TP.Apocalypse.AM,
                                                  {waist = "Sailfi belt +1"})
    sets.TP.Apocalypse.MidACC.AM.HighHaste =
        set_combine(sets.TP.Apocalypse.MidACC.AM, {waist = "Sailfi belt +1"})
    sets.TP.Apocalypse.HighACC.AM.HighHaste =
        set_combine(sets.TP.Apocalypse.HighACC.AM, {waist = "Sailfi belt +1"})
    ...
    sets.TP.Apocalypse.AM.HighHaste.STP =
        set_combine(sets.TP.Apocalypse.AM.STP, {waist = "Sailfi belt +1"})
    sets.TP.Apocalypse.MidACC.AM.HighHaste.STP =
        set_combine(sets.TP.Apocalypse.MidACC.AM.STP, {waist = "Sailfi belt +1"})
    ...
    sets.TP.Apocalypse.SAM.MidACC.HighHaste = set_combine(
                                                  ...
                                                  {waist = "Sailfi belt +1"})
    sets.TP.Apocalypse.SAM.HighACC.HighHaste =
        set_combine(sets.TP.Apocalypse.SAM.HighACC, {waist = "Sailfi belt +1"})
    ...
    sets.TP.Apocalypse.SAM.HighACC.HighHaste.STP = set_combine(sets.TP
                                                                   .Apocalypse
                                                                   .SAM.HighACC
                                                                   .STP, {
        waist = "Sailfi belt +1"
    ...
    sets.TP.Apocalypse.SAM.MidACC.AM =
        set_combine(sets.TP.Apocalypse.SAM.AM, {})
    sets.TP.Apocalypse.SAM.HighACC.AM = set_combine(
                                            sets.TP.Apocalypse.SAM.MidACC.AM, {})

    -- Apocalypse(AM Up: High Haste) /SAM TP Sets --
    sets.TP.Apocalypse.SAM.AM.HighHaste =
        set_combine(sets.TP.Apocalypse.SAM.AM, {waist = "Sailfi belt +1"})
    sets.TP.Apocalypse.SAM.MidACC.AM.HighHaste =
        set_combine(sets.TP.Apocalypse.SAM.MidACC.AM, {waist = "Sailfi belt +1"})
    ...
    sets.TP.Apocalypse.SAM.AM.HighHaste.STP = set_combine(
                                                  ...
                                                  {waist = "Sailfi belt +1"})
    sets.TP.Apocalypse.SAM.MidACC.AM.HighHaste.STP = set_combine(sets.TP
                                                                     .Apocalypse
                                                                     .SAM.MidACC
                                                                     .AM.STP, {
        waist = "Sailfi belt +1"
    })
    sets.TP.Apocalypse.SAM.HighACC.AM.HighHaste.STP = set_combine(sets.TP
                                                                      .Apocalypse
                                                                      .SAM
                                                                      .HighACC
                                                                      .AM.STP, {
    ...
    sets.TP.Caladbolg.HighHaste = set_combine(sets.TP.Caladbolg,
                                              {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.MidACC.HighHaste =
        set_combine(sets.TP.Caladbolg.MidACC, {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.HighACC.HighHaste =
        set_combine(sets.TP.Caladbolg.HighACC,
                    {ammo = "Coiste Bodhar", waist = "Sailfi belt +1"})
    ...
    sets.TP.Caladbolg.HighHaste.STP = set_combine(sets.TP.Caladbolg.STP,
                                                  {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.MidACC.HighHaste.STP =
        set_combine(sets.TP.Caladbolg.MidACC.STP, {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.HighACC.HighHaste.STP =
        set_combine(sets.TP.Caladbolg.HighACC.STP, {waist = "Sailfi belt +1"})
    ...
    sets.TP.Caladbolg.MidACC.AM.HighHaste = set_combine(
                                                ...
                                                {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.HighACC.AM.HighHaste =
        set_combine(sets.TP.Caladbolg.HighACC.AM, {})
    ...
    sets.TP.Caladbolg.AM.HighHaste.STP = set_combine(
                                             ...
                                             {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.MidACC.AM.HighHaste.STP =
        set_combine(sets.TP.Caladbolg.MidACC.STP, {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.HighACC.AM.HighHaste.STP =
        set_combine(sets.TP.Caladbolg.HighACC.STP, {waist = "Sailfi belt +1"})
    ...
    sets.TP.Caladbolg.SAM.HighHaste.STP =
        set_combine(sets.TP.Caladbolg.SAM.STP, {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.SAM.MidACC.HighHaste.STP =
        set_combine(sets.TP.Caladbolg.SAM.MidACC.STP, {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.SAM.HighACC.HighHaste.STP =
        set_combine(sets.TP.Caladbolg.SAM.HighACC.STP,
                    {waist = "Sailfi belt +1"})
    ...
    sets.TP.Caladbolg.SAM.AM.HighHaste =
        set_combine(sets.TP.Caladbolg.SAM.AM, {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.SAM.MidACC.AM.HighHaste =
        set_combine(sets.TP.Caladbolg.SAM.MidACC.AM, {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.SAM.HighACC.AM.HighHaste =
        set_combine(sets.TP.Caladbolg.SAM.HighACC.AM,
                    {ammo = "Coiste Bodhar", waist = "Sailfi belt +1"})
    ...
    sets.TP.Caladbolg.SAM.AM.HighHaste.STP = set_combine(
                                                 sets.TP.Caladbolg.SAM.HighHaste
                                                     .STP,
                                                 {waist = "Sailfi belt +1"})
    sets.TP.Caladbolg.SAM.MidACC.AM.HighHaste.STP = set_combine(sets.TP
                                                                    .Caladbolg
                                                                    .SAM.MidACC
                                                                    .STP, {
        waist = "Sailfi belt +1"
    })
    sets.TP.Caladbolg.SAM.HighACC.AM.HighHaste.STP = set_combine(sets.TP
                                                                     .Caladbolg
                                                                     .SAM
                                                                     .HighACC
                                                                     .STP, {
    ...
    sets.TP.Anguta.MidACC.HighHaste.STP =
        set_combine(sets.TP.Anguta.MidACC.STP, {})
    ...
    sets.TP.Anguta.SAM.HighHaste = set_combine(sets.TP.Anguta.SAM,
                                               {waist = "Sailfi belt +1"})
    sets.TP.Anguta.SAM.MidACC.HighHaste =
        set_combine(sets.TP.Anguta.SAM.MidACC, {})
    sets.TP.Anguta.SAM.HighACC.HighHaste =
        set_combine(sets.TP.Anguta.SAM.HighACC, {})
    ...
    sets.TP.Anguta.SAM.HighHaste.STP = set_combine(sets.TP.Anguta.SAM.STP,
                                                   {waist = "Sailfi belt +1"})
    sets.TP.Anguta.SAM.MidACC.HighHaste.STP =
        set_combine(sets.TP.Anguta.SAM.MidACC.STP, {})
    sets.TP.Anguta.SAM.HighACC.HighHaste.STP =
        set_combine(sets.TP.Anguta.SAM.HighACC.STP, {})
    ...
    -- Hybrid Set --
    sets.TP.Hybrid = set_combine(sets.TP.Caladbolg, {
        head = "Sakpata's Helm",
        body = "Sakpata's Breastplate",
        hands = "Sakpata's gauntlets",
        legs = "Sakpata's Cuisses",
