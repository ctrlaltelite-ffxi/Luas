...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'Annihilator'}
...
function init_gear_sets()
    ...
    sets.precast.WS['Last Stand'] = set_combine(sets.precast.WS, {
        ammo=gear.WSAmmo,
		head="Orion Beret +3",
        body={ name="Herculean vest", augments={'AGI+14','Rng. Acc.+13','Weapon skill damage +3%',}},
        hands="Meg. Gloves +2",
        legs="Arc. Braccae +1",
        feet={ name="Herculean Boots", augments={'Rng. Acc.+19', 'Rng. Atk.+12', 'DEX+7', 'Weapon skill damage +4%'}},
		neck="Scout's Gorget +1",
		waist="Fotia Belt",
    ...
    sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS['Last Stand'], {
        body={ name="Herculean vest", augments={'STR+10','Attack+3','Weapon skill damage +2%',}},
        ammo="Hauksbok Arrow",
        waist="Sailfi Belt +1"
        })
    ...
    sets.engaged = {
        ...
        hands="Adhemar Wristbands",
        legs="Samnuha Tights",
        feet={ name="Herculean Boots", augments={'"Triple Atk."+3','AGI+9','Accuracy+12',}},
        neck="Anu Torque",
        ear1="Cessance Earring",
        ear2="Brutal Earring",
        ring1="Ilabrat ring",
    ...
    --  sets.engaged = set_combine(sets.precast.RA, {})
    ...
    -- sets.engaged.DW = set_combine(sets.precast.RA, {})
    ...
    sets.buff['Velocity Shot'] = set_combine(sets.midcast.RA, {body="Amini Caban +1", back={ name="Belenus's Cape", augments={'Accuracy+20 Attack+20','"Dbl.Atk."+10',}}})
